...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        " backdrop-blur-sm   inset-shadow-sm inset-shadow-[#1d4ed8]  h-13 w-[350px] overflow-auto overflow-y-visible md:w-fit  items-center justify-center rounded-lg sm:px-2 sm:py-2",
        className
      )}
      {...props} />
  );
